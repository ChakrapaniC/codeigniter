...
window.onclick = function(event) {
  ...
  const pgHouses = [
    {
      id: 1,
      imgSrc: "assets/noida/images/img-1.jpg",
      alt: "img-1",
    ...
    {
      id: 2,
      imgSrc: "assets/noida/images/img-2.jpg",
      alt: "img-1",
    ...
    {
      id: 3,
      imgSrc: "assets/noida/images/img-3.jpg",
      alt: "img-1",
    ...
    {
      id: 4,
      imgSrc: "assets/noida/images/img-4.jpg",
      alt: "img-1",
    ...
    {
      id: 5,
      imgSrc: "assets/noida/images/img-5.jpg",
      alt: "img-1",
    ...
    {
      id: 6,
      imgSrc: "assets/noida/images/img-6.jpg",
      alt: "img-1",
    ...
    {
      id: 7,
      imgSrc: "assets/noida/images/img-7.jpg",
      alt: "img-1",
    ...
    {
      id: 8,
      imgSrc: "assets/noida/images/img-8.jpg",
      alt: "img-1",
    ...
    {
      id: 9,
      imgSrc: "assets/noida/images/img-9.jpg",
      alt: "img-1",
    ...
    {
      id: 10,
      imgSrc: "assets/noida/images/img-10.jpg",
      alt: "img-1",
    ...
    {
      id: 11,
      imgSrc: "assets/noida/images/img-11.jpg",
      alt: "img-1",
    ...
    {
      id: 12,
      imgSrc: "assets/noida/images/img-12.jpg",
      alt: "img-1",
      name: "Covie 108",
    ...
    {
      id: 14,
      imgSrc: "assets/noida/images/img-14.jpg",
      alt: "img-1",
    ...
    {
      id: 15,
      imgSrc: "assets/noida/images/img-15.jpg",
      alt: "img-1",
      name: "Stanza Living Modena House",
      location: "Manayata Tech Park, Noida",
      price: "₹9,099 / month",
  ...
  const showDetails = (id) => {
    ...
    if (selectedHouse) {
        ...
        window.location.href = `Singlepage/noidaCity${queryParams}`;
    }
  }
