...
window.onclick = function(event) {
  ...
  const pgHouses = [
      {
        id: 1,
        imgSrc: "assets/gurugram/images/img-1.webp",
        alt: "img-1",
      ...
      {
        id: 2,
        imgSrc: "assets/gurugram/images/img-2.jpg",
        alt: "img-1",
      ...
      {
        id: 3,
        imgSrc: "assets/gurugram/images/img-3.webp",
        alt: "img-1",
      ...
      {
        id: 4,
        imgSrc: "assets/gurugram/images/img-4.webp",
        alt: "img-1",
      ...
      {
        id: 5,
        imgSrc: "assets/gurugram/images/img-5.jpg",
        alt: "img-1",
      ...
      {
        id: 6,
        imgSrc: "assets/gurugram/images/img-6.jpg",
        alt: "img-1",
      ...
      {
        id: 7,
        imgSrc: "assets/gurugram/images/img-7.jpg",
        alt: "img-1",
      ...
      {
        id: 8,
        imgSrc: "assets/gurugram/images/img-8.webp",
        alt: "img-1",
      ...
      {
        id: 9,
        imgSrc: "assets/gurugram/images/img-9.webp",
        alt: "img-1",
      ...
      {
        id: 10,
        imgSrc: "assets/gurugram/images/img-10.jpg",
        alt: "img-1",
      ...
      {
        id: 11,
        imgSrc: "assets/gurugram/images/img-11.jpg",
        alt: "img-1",
      ...
      {
        id: 12,
        imgSrc: "assets/gurugram/images/img-12.jpg",
        alt: "img-1",
        name: "Covie 108",
      ...
      {
        id: 13,
        imgSrc: "assets/gurugram/images/img-13.jpg",
        alt: "img-1",
      ...
      {
        id: 14,
        imgSrc: "assets/gurugram/images/img-14.jpg",
        alt: "img-1",
      ...
      {
        id: 15,
        imgSrc: "assets/gurugram/images/img-15.jpg",
        alt: "img-1",
        name: "Stanza Living Modena House",
        location: "Manayata Tech Park, Gurugram",
        price: "₹9,099 / month",
  ...
  const showDetails = (id) => {
    ...
    if (selectedHouse) {
        ...
        window.location.href = `Singlepage/gurugramCity${queryParams}`;
    }
  }
