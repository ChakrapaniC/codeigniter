...
window.onclick = function(event) {
  ...
  const pgHouses = [
    {
      id: 1,
      imgSrc: "assets/pune/images/img-1.webp",
      alt: "img-1",
    ...
    {
      id: 2,
      imgSrc: "assets/pune/images/img-2.webp",
      alt: "img-1",
    ...
    {
      id: 3,
      imgSrc: "assets/pune/images/img-3.jpg",
      alt: "img-1",
    ...
    {
      id: 4,
      imgSrc: "assets/pune/images/img-4.webp",
      alt: "img-1",
    ...
    {
      id: 5,
      imgSrc: "assets/pune/images/img-5.webp",
      alt: "img-1",
    ...
    {
      id: 6,
      imgSrc: "assets/pune/images/img-6.jpg",
      alt: "img-1",
    ...
    {
      id: 7,
      imgSrc: "assets/pune/images/img-7.webp",
      alt: "img-1",
    ...
    {
      id: 8,
      imgSrc: "assets/pune/images/img-8.webp",
      alt: "img-1",
    ...
    {
      id: 9,
      imgSrc: "assets/pune/images/img-9.jpg",
      alt: "img-1",
    ...
    {
      id: 10,
      imgSrc: "assets/pune/images/img-10.jpg",
      alt: "img-1",
    ...
    {
      id: 11,
      imgSrc: "assets/pune/images/img-11.jpg",
      alt: "img-1",
    ...
    {
      id: 12,
      imgSrc: "assets/pune/images/img-12.jpg",
      alt: "img-1",
      name: "HelloWorld EON",
      location: "Wagholi, Pune",
      price: "₹11,500 / month",
    ...
    {
      id: 13,
      imgSrc: "assets/pune/images/img-13.jpg",
      alt: "img-1",
    ...
    {
      id: 14,
      imgSrc: "assets/pune/images/img-14.jpg",
      alt: "img-1",
    ...
    {
      id: 15,
      imgSrc: "assets/pune/images/img-15.webp",
      alt: "img-1",
  ...
  const showDetails = (id) => {
    ...
    if (selectedHouse) {
        ...
        window.location.href = `Singlepage/puneCity${queryParams}`;
    }
  }
