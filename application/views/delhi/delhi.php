...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/delhi/css/delhi.css" />
  ...
  <body>
    <div class="city-container">
            ...
            <div class="search-box">
              <div class="inner-search">
                ...
                <div class="dropdown-menu">
                  ...
                  <a href="bangalore/city.html">Okhla</a>
                  <a href="delhi/delhi.html">Nehru Place</a>
                  <a href="noida/noida.html">Hauz Khas</a>
                  <a href="gurugram/gurugram.html">Greater Kailash</a>
                  <a href="hyderabad/hyderabad.htm">Jasola</a>
                  <a href="pune/pune.html">SaketGreen</a>
                  <a href="mumbai/mumbai.html">Malviya Nagar</a>
                  <a href="ahmedabad/ahmedabad.html">Green Park</a>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div class="coliving-spaces" data-aos="zoom-in" data-aos-duration="1000">
          <div class="card" onclick="showDetails(1)">
            <img src="assets/delhi/images/img-1.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostel Yard - Orchid House (Girls)</h4>
              <p>Vijay nagar, New Delhi</p>
              <h4>₹14,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(2)">
            <img src="assets/delhi/images/img-2.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostel Yard - Rose House (Girls)</h4>
              <p>Vijay nagar, New Delhi</p>
              <h4>₹13,499 / month</h4>
              <p>Call Owner</p>
            </div>
          ...
          <div class="card" onclick="showDetails(3)">
            <img src="assets/delhi/images/img-3.jpg" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Romford House (Male)</h4>
              <p>North Campus, New Delhi</p>
              <h4>₹18,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(4)">
            <img src="assets/delhi/images/img-4.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostel Yard - Tulip House (Girls)</h4>
              <p>Kamla Nagar, New Delhi</p>
              <h4>₹21,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(5)">
            <img src="assets/delhi/images/img-5.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostel Yard - Lily House (Girls)</h4>
              <p>Block G, Kamla Nagar, Delhi</p>
              <h4>₹14,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(6)">
            <img src="assets/delhi/images/img-6.jpg" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Quito House (Male)</h4>
          ...
          <div class="card" onclick="showDetails(7)">
            <img src="assets/delhi/images/img-7.jpg" alt="img-1" />
            <div class="details">
              <h4> The Hostel Yard - Snapdragon (Boys)</h4>
              <p>Kamla Nagar, New Delhi</p>
              <h4>₹18,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(8)">
            <img src="assets/delhi/images/img-8.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostel Yard - Bluebell House (Boys)</h4>
              <p>SKamla Nagar, New Delhi</p>
              <h4>₹16,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(9)">
            <img src="assets/delhi/images/img-9.jpg" alt="img-1" />
            <div class="details">
              <h4>The Hostelyard - Daisy House (Girls)</h4>
              <p>Satya Niketan, Delhi</p>
              <h4>₹12,000 / month</h4>
              <p>Call Owner</p>
      ...
      <section class="add">
        <div class="image-container">
          <img src="assets/delhi/images/bg.jpg" />
          <div class="more-area">
      ...
      <section class="more-cards">
        <div class="card" onclick="showDetails(10)">
          <img src="assets/delhi/images/img-10.jpg" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Los Angeles House (Female)</h4>
            <p>Vijay Nagar, Delhi, 110009</p>
            <h4> ₹21,000 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(11)">
          <img src="assets/delhi/images/img-11.jpg" alt="img-1" />
          <div class="details">
            <h4>The Hostelyard - Sage House (Girls)</h4>
            <p>Satya Niketan, Delhi
            </p>
            <h4>₹14,000 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(12)">
          <img src="assets/delhi/images/img-12.jpg" alt="img-1" />
          <div class="details">
            <h4>Covie 108</h4>
            <p>Medicity, Delhi</p>
            <h4>₹15,150 / month</h4>
        ...
        <div class="card" onclick="showDetails(13)">
          <img src="assets/delhi/images/img-13.jpg" alt="img-1" />
          <div class="details">
        ...
        <div class="card" onclick="showDetails(14)">
          <img src="assets/delhi/images/img-14.jpg" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Modena House</h4>
            <p>Manayata Tech Park, Delhi</p>
            <h4>₹9,099 / month</h4>
            <p>Call Owner</p>
          </div>
        </div>
        <div class="card" onclick="showDetails(15)">
          <img src="assets/delhi/images/img-15.jpg" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Modena House</h4>
            <p>Manayata Tech Park, Delhi</p>
            <h4>₹9,099 / month</h4>
      ...
      <section class="top-amenities">
        <div class="container">
          <div class="row" data-aos="fade-in" data-aos-duration="1000">
            <div class="left">
              <img  src="assets/delhi/images/amenities-img.png"/>
            </div>
            <div class="right">
                ...
                <div class="icons">
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/food.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Tasty Food</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/car.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Parking</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/cleaning.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/wifi.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/washing-machine.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Laundry</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/delhi/images/bed.png" class="image"/>
                    </div>
                    <div class="details">
                     ...
                     <div class="mobile-container">
                      <div class="mobile-row">
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/bed.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Bed</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/wifi.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Wifi</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/food.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Food</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/car.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Parking</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/cleaning.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Cleaning</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/delhi/images/washing-machine.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Laundry</p>
                          </div>
    ...
    <script src="assets/delhi/js/Dcity.js"></script>
