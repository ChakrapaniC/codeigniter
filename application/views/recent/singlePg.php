...
<head>
    ...
    <link rel="stylesheet" href="assets/recent/css/singlePg.css" />
...
<body>
    <div class="container">
        <div class="inner-container" data-aos="fade-out" data-aos-duration="1000">
            <nav class="navbar">
                ...
                <div class="btn">
                    <button class="btn3" onclick="toggleModal()">Book Now</button>
                </div>
            </nav>
            ...
            <div class="content">
                ...
                <section class="amenities">
                    ...
                    <div class="all-amenities">
                        <div>
                            <p>
                                <img src="assets/recent/images/amenity/wifi.png" />
                                <span>Wifi</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/tv.png" />
                                <span>Tv</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/parking.png" />
                                <span>Parking</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/recent/images/amenity/cupbord.png" />
                                <span>Cupbord</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/deposite.png" />
                                <span>Deposite</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/icons8-do-not-touch-100.png" />
                                <span>No Restriction</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/recent/images/amenity/kitchen.png" />
                                <span>Kitchen</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/housekeeping.png" />
                                <span>Housekeeping</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/icons8-lease-100.png" />
                                <span>Security</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/recent/images/amenity/icons8-hot-springs-100 (1).png" />
                                <span>Geyser</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/icons8-bathroom-100.png" />
                                <span>Bathroom</span>
                            </p>
                            <p>
                                <img src="assets/recent/images/amenity/power.png" />
                ...
                <section class="pricing" style="margin: 40px 0px;">
                    ...
                    <div class="plans">
                        <div class="imga">
                            <img src="assets/recent/images/single sharing.jpeg" />
                        </div>
                        <div class="sharing">
                            <h5>Private Room</h5>
                    ...
                    <div class="plans">
                        <div class="imga">
                            <img src="assets/recent/images/double-sharing.jpeg" />
                        </div>
                        <div class="sharing">
    ...
    <script src="assets/recent/js/pgInfo.js"></script>
