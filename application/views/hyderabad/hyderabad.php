...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/hyderabad/css/hyderabad.css" />
  ...
  <body>
    <div class="city-container">
      ...
      <section class="cards" >
        <div class="heading" >
          <p>Coliving Spaces in Hyderabad</p>
          <div class="area">
            <div class="search-box">
              <div class="inner-search">
                ...
                <div class="dropdown-menu">
                  ...
                  <a href="bangalore/city.html">Madhapur</a>
                  <a href="delhi/delhi.html">Jubilee Hills</a>
                  <a href="noida/noida.html">Hitech City</a>
                  <a href="gurugram/gurugram.html">Begumpet</a>
                  <a href="hyderabad/hyderabad.htm">KukatpallyQ City</a>
                  <a href="pune/pune.html">Serilingampally</a>
                  <a href="mumbai/mumbai.html">MandalGachibowli</a>
                  <a href="ahmedabad/ahmedabad.html">Hafeezpet</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="coliving-spaces" data-aos="zoom-in" data-aos-duration="1000">
          <div class="card" onclick="showDetails(1)">
            <img src="assets/hyderabad/images/img-1.jpg" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Dunkirk House</h4>
              <p>sector 48, hyderabad</p>
              <h4>₹11,799 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(2)">
            <img src="assets/hyderabad/images/img-2.webp" alt="img-1" />
            <div class="details">
              <h4>Cloud Nine Rooms 56</h4>
              <p>Sector- 43, Golf Course Road, Hyderabad</p>
              <h4>₹13,999 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(3)">
            <img src="assets/hyderabad/images/img-3.webp" alt="img-1" />
            <div class="details">
              <h4>RentDoor Sector 46</h4>
              <p>Sector 46, Hyderabad</p>
              <h4>₹28,000 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(4)">
            <img src="assets/hyderabad/images/img-4.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Taiping House</h4>
              <p>Sector 39, Hyderabad</p>
              <h4>₹24,299 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(5)">
            <img src="assets/hyderabad/images/img-5.webp" alt="img-1" />
            <div class="details">
              <h4>Livstation - Near Huda Metro</h4>
              <p>Ardee City, Sector 52, Hyderabad</p>
              <h4>₹15,000 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(6)">
            <img src="images/img-6.webp" alt="img-1" />
            <div class="details">
          ...
          <div class="card" onclick="showDetails(7)">
            <img src="assets/hyderabad/images/img-7.jpg" alt="img-1" />
            <div class="details">
              <h4>Cloud Nine Rooms</h4>
              <p>Sector 55, Hyderabad</p>
              <h4>₹12,999 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(8)">
            <img src="assets/hyderabad/images/img-8.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Pisa House</h4>
              <p>Sector 52, Hyderabad</p>
              <h4>₹24,099 / month</h4>
              <p>Call Owner</p>
            </div>
          </div>
          <div class="card" onclick="showDetails(9)">
            <img src="assets/hyderabad/images/img-9.webp" alt="img-1" />
            <div class="details">
      ...
      <section class="add">
        <div class="image-container">
          <img src="assets/hyderabad/images/bg.jpg" />
          <div class="more-area">
            ...
            <ul>
              ...
              <li>Hitech City</li>
              <li> Begumpet</li>
              <li>KukatpallyQ City</li>
              <li>Hafeezpet</li>
              <li>Serilingampally</li>
              <li>MandalGachibowli and More..</li>
      ...
      <section class="more-cards">
        <div class="card" onclick="showDetails(10)">
          <img src="assets/hyderabad/images/img-10.jpg" alt="img-1" />
          <div class="details">
        ...
        <div class="card" onclick="showDetails(11)">
          <img src="assets/hyderabad/images/img-11.webp" alt="img-1" />
          <div class="details">
        ...
        <div class="card" onclick="showDetails(12)">
          <img src="assets/hyderabad/images/img-12.webp" alt="img-1" />
          <div class="details">
            <h4>Covie 108</h4>
            <p>Medicity, Hyderabad</p>
            <h4>₹15,150 / month</h4>
            <p>Call Owner</p>
          </div>
        </div>
        <div class="card" onclick="showDetails(13)">
          <img src="assets/hyderabad/images/img-13.webp" alt="img-1" />
          <div class="details">
        ...
        <div class="card" onclick="showDetails(14)">
          <img src="assets/hyderabad/images/img-14.webp" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Modena House</h4>
            <p>Manayata Tech Park, Hyderabad</p>
            <h4>₹9,099 / month</h4>
            <p>Call Owner</p>
          </div>
        </div>
        <div class="card" onclick="showDetails(15)">
          <img src="assets/hyderabad/images/img-15.jpg" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Modena House</h4>
            <p>Manayata Tech Park, Hyderabad</p>
            <h4>₹9,099 / month</h4>
      ...
      <section class="top-amenities">
        <div class="container">
          <div class="row" data-aos="fade-in" data-aos-duration="1000">
            <div class="left">
              <img  src="assets/hyderabad/images/amenities-img.png"/>
            </div>
            <div class="right">
                ...
                <div class="icons">
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/food.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Tasty Food</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/car.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Parking</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/cleaning.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/wifi.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/washing-machine.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Laundry</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/hyderabad/images/bed.png" class="image"/>
                    </div>
                    <div class="details">
                     ...
                     <div class="mobile-container">
                      <div class="mobile-row">
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/bed.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Bed</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/wifi.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Wifi</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/food.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Food</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/car.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Parking</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/cleaning.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Cleaning</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/hyderabad/images/washing-machine.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Laundry</p>
                          </div>
    ...
    <script src="assets/hyderabad/js/Hcity.js"></script>
