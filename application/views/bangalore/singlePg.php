...
<head>
    ...
    <link rel="stylesheet" href="assets/bangalore/css/singlePg.css" />
...
<body>
            ...
            <div class="content">
                ...
                <section class="amenities">
                    ...
                    <div class="all-amenities">
                        <div>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/wifi.png" />
                                <span>Wifi</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/tv.png" />
                                <span>Tv</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/parking.png" />
                                <span>Parking</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/cupbord.png" />
                                <span>Cupbord</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/deposite.png" />
                                <span>Deposite</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/icons8-do-not-touch-100.png" />
                                <span>No Restriction</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/kitchen.png" />
                                <span>Kitchen</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/housekeeping.png" />
                                <span>Housekeeping</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/icons8-lease-100.png" />
                                <span>Security</span>
                            </p>
                        </div>
                        <div>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/icons8-hot-springs-100 (1).png" />
                                <span>Geyser</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/icons8-bathroom-100.png" />
                                <span>Bathroom</span>
                            </p>
                            <p>
                                <img src="assets/bangalore/banglore-coliving/amenity/power.png" />
                ...
                <section class="pricing" style="margin: 40px 0px;">
                    ...
                    <div class="plans">
                        <div class="imga">
                            <img src="assets/bangalore/banglore-coliving/single sharing.jpeg" />
                        </div>
                        <div class="sharing">
                            <h5>Private Room</h5>
                    ...
                    <div class="plans">
                        <div class="imga">
                            <img src="assets/bangalore/banglore-coliving/double-sharing.jpeg" />
                        </div>
                        <div class="sharing">
        ...
        <div class="footer-content">
            <div class="rows">
                <div class="content-row">
                    <div>
                        <div class="Housify" style="margin-bottom: 10px;">
                            <h4>HOUSIFY</h4>
                        </div>
                        <div class="text">
                            <p> Housify is a top leading platform to provide couple-friendly space in pan India. Our
                                team physically verified all the listed spaces, these are perfect and offer you a
                                premium, prestigious, and trouble-free lifestyle. Housify is an ideal platform that
                                provides independence, liberty, as well as freedom to couples. You just need to follow
                                three easy steps to onboard on your desired couple-friendly living accommodation with
                                Housify.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-row" id="contact-row">
                    <div>
                        ...
                        <div class="two">
                            <p style="text-align: justify;">Don’t miss to subscribe to our new feeds, kindlyy fill the
                                form below.</p>
                        </div>
    ...
    <script src="assets/bangalore/js/pgInfo.js"></script>
