...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/pune/css/pune.css" />
  ...
  <body>
    <div class="city-container">
      <nav class="navbar">
        ...
        <div class="btn">
          <button class="btn3" onclick="toggleModal()">Request Call</button>
        </div>
      </nav>
      ...
      <section class="cards" >
            ...
            <div class="search-box">
              <div class="inner-search">
                ...
                <div class="dropdown-menu">
                  ...
                  <a href="bangalore/city.html">Hinjewadi</a>
                  <a href="delhi/delhi.html">Baner</a>
                  <a href="noida/noida.html">Kharadi</a>
                  <a href="gurugram/gurugram.html">Kothrud</a>
                  <a href="hyderabad/hyderabad.htm">kular</a>
                  <a href="pune/pune.html">Magarpatta</a>
                  <a href="mumbai/mumbai.html">AundhKalyani Nagar</a>
                  <a href="ahmedabad/ahmedabad.html">Sector 56</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="coliving-spaces" data-aos="zoom-in" data-aos-duration="1000">
          <div class="card" onclick="showDetails(1)">
            <img src="assets/pune/images/img-1.webp" alt="img-1" />
            <div class="details">
              <h4>Covie Viman Nagar</h4>
          ...
          <div class="card" onclick="showDetails(2)">
            <img src="assets/pune/images/img-2.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Tel Aviv House</h4>
              <p>Baner, Pune</p>
              <h4>₹11,399 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(3)">
            <img src="assets/pune/images/img-3.jpg" alt="img-1" />
            <div class="details">
              <h4>Tribe Luxury Hostel Viman Nagar</h4>
              <p>Mascot Centre, Pune</p>
              <h4>₹28,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(4)">
            <img src="assets/pune/images/img-4.webp" alt="img-1" />
            <div class="details">
              <h4> Stanza Living Mogilev House</h4>
              <p>Narhe Gaon, Pune</p>
              <h4>₹7,299 / month</h4>
              <p>Call Owner</p>
            </div>
          ...
          <div class="card" onclick="showDetails(5)">
            <img src="assets/pune/images/img-5.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Marseille House</h4>
              <p>Hinjawadi, Pune</p>
              <h4>₹11,799 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(6)">
            <img src="assets/pune/images/img-6.jpg" alt="img-1" />
            <div class="details">
              <h4> Tribe Luxury Hostel Wakad</h4>
              <p>ACE Almighty, Pune</p>
              <h4>₹16,000 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(7)">
            <img src="assets/pune/images/img-7.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Alanya House</h4>
              <p>Kharadi, Pune</p>
              <h4>₹10,099 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(8)">
            <img src="assets/pune/images/img-8.webp" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Queluz House</h4>
              <p>Hadapsar, Pune</p>
              <h4>₹11,799 / month</h4>
              <p>Call Owner</p>
          ...
          <div class="card" onclick="showDetails(9)">
            <img src="assets/pune/images/img-9.jpg" alt="img-1" />
            <div class="details">
              <h4>Stanza Living Torreon House</h4>
              <p>Wagholi, Pune</p>
              <h4>₹9,199 / month</h4>
              <p>Call Owner</p>
            </div>
      ...
      <section class="add">
        <div class="image-container">
          <img src="assets/pune/images/bg.jpg" />
          <div class="more-area">
            ...
            <ul>
              ...
              <li>Magarpatta</li>
              <li>Sector 56</li>
              <li>AundhKalyani Nagar and More...</li>
      ...
      <section class="more-cards">
        <div class="card" onclick="showDetails(10)">
          <img src="assets/pune/images/img-10.jpg" alt="img-1" />
          <div class="details">
            <h4>Stanza living Malmo House</h4>
            <p>Sakore Nagar, Viman Nagar, Pune, Maharashtra</p>
            <h4>₹23,500 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(11)">
          <img src="assets/pune/images/img-11.jpg" alt="img-1" />
          <div class="details">
            <h4>Smart Living PG Kalyani Nagar (Girls)</h4>
        ...
        <div class="card" onclick="showDetails(12)">
          <img src="assets/pune/images/img-12.jpg" alt="img-1" />
          <div class="details">
            <h4>HelloWorld EON</h4>
            <p>Wagholi, Pune</p>
            <h4>₹11,500 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(13)">
          <img src="assets/pune/images/img-13.jpg" alt="img-1" />
          <div class="details">
            <h4>Wagholi, Pune</h4>
            <p>HelloWorld Everest</p>
            <h4>₹15,000 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(14)">
          <img src="assets/pune/images/img-14.jpg" alt="img-1" />
          <div class="details">
            <h4>HelloWorld Embassy</h4>
            <p>Hinjewadi, Pune</p>
            <h4>₹11,000 / month</h4>
            <p>Call Owner</p>
        ...
        <div class="card" onclick="showDetails(15)">
          <img src="assets/pune/images/img-15.webp" alt="img-1" />
          <div class="details">
            <h4>Stanza Living Modena House</h4>
            <p>Manayata Tech Park, Pune </p>
            <h4>₹9,099 / month</h4>
            <p>Call Owner</p>
          </div>
        </div>
      ...
      <section class="top-amenities">
        <div class="container">
          <div class="row" data-aos="fade-in" data-aos-duration="1000">
            <div class="left">
              <img  src="assets/pune/images/amenities-img.png"/>
            </div>
            <div class="right">
                ...
                <div class="icons">
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/food.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Tasty Food</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/car.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Parking</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/cleaning.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/wifi.png" class="image"/>
                    </div>
                    <div class="details">
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/washing-machine.png" class="image"/>
                    </div>
                    <div class="details">
                      <h4>Laundry</h4>
                  ...
                  <div class="icon">
                    <div class="img-container">
                      <img src="assets/pune/images/bed.png" class="image"/>
                    </div>
                    <div class="details">
                     ...
                     <div class="mobile-container">
                      <div class="mobile-row">
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/bed.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Bed</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/wifi.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Wifi</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/food.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Food</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/car.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Parking</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/cleaning.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Cleaning</p>
                          </div>
                        ...
                        <div class="mobile-icon">
                          <div class="icon-img">
                              <img src="assets/pune/images/washing-machine.png" alt="bed"/>
                          </div>
                          <div class="text">
                            <p>Laundry</p>
                          </div>
    ...
    <script src="assets/pune/js/Pcity.js"></script>
